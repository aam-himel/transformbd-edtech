...
import { Play, X, Users, Calendar, ChevronDown, PlayCircle, Clock, Star } from 'lucide-react';
        ...
        <div className="min-h-screen bg-slate-900 text-white relative overflow-hidden">
            ...
            <div className="relative z-10">
                ...
                <div className="container mx-auto px-6 py-16">
                        ...
                        <div className="space-y-8">
                            ...
                            <div>
                                ...
                                <p className="text-lg text-gray-300 leading-relaxed">
                                    প্রোডাক্ট ম্যানেজমেন্টের ব্যাসিক থেকে অ্যাডভান্সড ক্রিয়েটিভ, মার্কেট অনুগত এক্সপেরিমেন্ট, তার বিশ্লেষণের জন্য
                                    সর্বোচ্চ নিয়ে সাজানো ডিজিটাল প্রোডাক্ট ম্যানেজমেন্ট লাইভ কোর্স। ইতালি এক্সপার্টদের ২০ বছরের এক্সপেরিমেন্টেরা
                                    থেকে শিখুন প্রোডাক্ট অপটিমাইজেশন থেকে শুরু করে প্রফেবর লঞ্চ পর্যন্ত।
                                </p>
                            </div>
                        ...
                        <div className="relative">
                            <div className="bg-gradient-to-r from-slate-800 to-slate-700 rounded-2xl p-6 border border-slate-600/50">
                                <div className="flex items-center gap-2 mb-4">
                                    ...
                                    <span className="text-sm font-medium">কিভাবে দেখে নিন কোর্সের ডেমো ক্লাস</span>
                                </div>
                    ...
                    {/* Curriculum Section */}
                    <div className="mt-24">
                        <h2 className="text-3xl font-bold text-center mb-4">কারিকুলাম</h2>
                        ...
                        <div className="max-w-4xl mx-auto space-y-4">
                            {modules.map((module) => (
                                <div key={module.id} className="bg-slate-800/50 rounded-xl border border-slate-700/50 overflow-hidden">
                                    <button
                                        className="w-full flex items-center justify-between p-6 text-left hover:bg-slate-700/30 transition-colors"
                                        onClick={() => toggleModule(module.id)}
                                    >
                                        <div className="flex items-center gap-4">
                                            <div className={`w-12 h-12 ${module.color} rounded-lg flex items-center justify-center text-xl`}>
                                                {module.icon}
                                            </div>
                                            <div>
                                                <div className="text-sm text-gray-400">{module.number}</div>
                                    ...
                                    {activeModule === module.id && (
                                        <div className="px-6 pb-6 pt-2">
                                            <div className="bg-slate-900/50 rounded-lg p-4">
                                                <h4 className="font-semibold mb-3 text-cyan-400">এই মডিউলে যা শিখবেন:</h4>
